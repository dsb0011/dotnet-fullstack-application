    ...
    public partial class AddCountriesTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Countries",
                columns: new[] { "Id", "Capital", "Continent", "IsoCode", "Name" },
                values: new object[,]
                {
                    { 1, "New Delhi", "Asia", "IN", "India" },
                    { 2, "Washington DC", "North America", "US", "USA" },
                    { 3, "Madrid", "Europe", "ESP", "Spain" },
                    { 4, "Wellington", "Ocenia", "NZE", "New Zealand" },
                    { 5, "Rio De Janeiro", "South America", "BRA", "Brazil" }
                });
        }
